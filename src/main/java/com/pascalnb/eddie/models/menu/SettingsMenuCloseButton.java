...
public class SettingsMenuCloseButton extends EddieButton<SettingsMenu> {

    public SettingsMenuCloseButton(SettingsMenu component, String id) {
        super(component, id);
    }
