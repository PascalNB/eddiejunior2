...
public class SessionAddModal extends UpdatingModal<SessionComponent> {

    public SessionAddModal(SessionComponent component, String id) {
        super(component, id);
    }
    ...
    public Modal getEntity() {
        ...
        return Modal.create(getId(), "Add message")
            .addComponents(
                TextDisplay.ofFormat("Add the message that will be sent to %s.", session.channel().getAsMention()),
                Label.of(
                    "Message",
